...
***This is the main code for ImageNet that we modify to generate the precomputed features embeddings and other related information.
The result is saved at the `intermediate_output` folder.***
...
parser.add_argument('--data_dir', metavar='DIR', required=True, default="/home/miao/datasets/ImageNet",
                    help='path to dataset')
parser.add_argument('--output_dir', metavar='DIR', required=True, default="intermediate_output/imagenet_train",
...
def validate(args):
    ...
    with torch.no_grad():
        ...
        # save_folder = "intermediate_output/imagenet"
